  ...
  'inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-white transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-slate-950 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 dark:ring-offset-slate-950 dark:focus-visible:ring-slate-300',
  {
    variants: {
      variant: {
        ...
        outline:
          'border border-slate-200 bg-white hover:text-slate-900 dark:border-slate-800 dark:bg-slate-950',
        secondary: 'bg-slate-100 text-slate-900 dark:bg-slate-800 dark:text-slate-50',
        ghost: 'hover:bg-slate-100 hover:text-slate-900',
        link: 'text-slate-900 border-b border-primary-offset-4 hover:border-b border-primary dark:text-slate-50',
      },
      size: {
